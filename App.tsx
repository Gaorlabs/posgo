...
const CashControlModal = ({ isOpen, onClose, activeShift, onOpenShift, onCloseShift, onMovement, settings, transactions, movements }: any) => {
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[60] flex items-center justify-center p-4 animate-fade-in">
       <div className="bg-white w-full max-w-lg rounded-3xl overflow-hidden shadow-2xl animate-bounce-slight">
             ...
             {!activeShift ? (
                ...
                <div className="space-y-6">
                   <div className="grid grid-cols-2 gap-3">
                        ...
                        {(totals.yape === 0 && totals.plin === 0 && totals.card === 0) && (
                            <div className="col-span-2 text-center py-2 text-xs text-slate-400 font-medium italic">No hay ingresos digitales aún.</div>
                        )}
                   </div>
